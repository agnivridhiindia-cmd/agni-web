...
export default function GlobalError({
 ...
 <Link
 href="/"
 className="w-full inline-flex items-center justify-center px-5 py-3 rounded-lg bg-white/70  border border-cyan-200/90 hover:bg-white/90 text-[#0891B2] shadow-[inset_0_1px_1px_rgba(255,255,255,0.85),0_2px_8px_rgba(0,0,0,0.03)] text-sm font-medium transition-all [transform:translateZ(0)]"
            >
              Return to Home
            </Link>
          </div>
