...
export function CaseStudyRelatedServices({ serviceSlugs }: CaseStudyRelatedServicesProps) {
 ...
 <div
 key={service.slug}
 className="rounded-3xl border border-white/90 bg-white/85 p-6 sm:p-7 shadow-[0_16px_40px_rgba(15,23,42,0.08)]  hover:border-amber-400/60 hover:shadow-[0_24px_50px_rgba(14,165,233,0.18)] transition-all flex flex-col justify-between group"
 >
