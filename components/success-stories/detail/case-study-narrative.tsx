    ...
    <article className="space-y-12 sm:space-y-16 text-slate-900">
        ...
        <section aria-labelledby="section-process" className="space-y-6">
          ...
          <ol className="grid grid-cols-1 gap-4">
            {study.process.map((step, idx) => (
              <li
                key={idx}
                className="flex items-start gap-4 p-4 sm:p-5 rounded-2xl border border-white/90 bg-white/85 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl hover:shadow-[0_16px_40px_rgba(14,165,233,0.12)] transition-all"
              >
      ...
      {study.quote && study.quote.text && (
        <section aria-label="Client Perspective" className="pt-4">
          <blockquote className="relative rounded-3xl border border-white/90 bg-white/85 p-6 sm:p-8 space-y-4 shadow-[0_16px_40px_rgba(15,23,42,0.08)] backdrop-blur-xl">
