...
export function StoryCard({ study, className }: StoryCardProps) {
 ...
 <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-mono font-bold uppercase tracking-wider bg-white/95  border border-[#A6CCEA] text-slate-800 shadow-sm">
 ...
 <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-950/80  border border-amber-500/40 text-amber-300 font-mono text-xs font-bold shadow-xs">
 <span>{metric}</span>
 ...
 <div className="absolute inset-x-0 bottom-0 z-20 transform transition-transform duration-500 ease-out translate-y-full group-hover:translate-y-0 group-focus-within:translate-y-0 p-5 sm:p-6 text-left rounded-t-3xl bg-white/95  border-t border-[#A6CCEA] shadow-[0_-10px_30px_rgba(15,23,42,0.15)] max-h-[85%] overflow-y-auto no-scrollbar text-slate-900">
