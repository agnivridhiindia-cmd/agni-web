          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "bg-cyan-50 text-[#0F0A1A] border border-[#0891B2]/60 shadow-xs font-semibold"
                  : "bg-white text-[#A8A29E] border border-cyan-100 hover:bg-cyan-50 hover:text-[#0F0A1A] hover:border-cyan-200"
              )}
            >
              <span>{cat.label}</span>
              <span
