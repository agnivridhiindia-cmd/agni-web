  ...
  return (
    <section className="space-y-8 bg-white border border-slate-200/90 rounded-xl p-6 sm:p-8 lg:p-10 shadow-card">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-6">
        <div>
          <div className="flex items-center gap-2">
            <Eyebrow>Phase 6 Verification</Eyebrow>
            <Badge variant="primary">Motion System Live</Badge>
          ...
          <h2 className="type-h2 text-slate-900 mt-1">
            Motion, Transitions &amp; Interaction System Review
          </h2>
          <p className="type-body text-slate-600 max-w-2xl mt-1.5">
            Test and inspect all Phase 6 motion primitives, micro-feedback, card tilt, magnetic physics, and reduced-motion compliance directly on the home page.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs font-mono bg-slate-50 border border-slate-200/80 p-3 rounded-lg">
          ...
          <span className="font-semibold text-slate-800">
            {hasFinePointer ? "Fine (Mouse/Trackpad)" : "Coarse (Touch)"}
          </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <CardContent>
            <StaggerContainer key={staggerKey} className="space-y-2">
              <StaggerItem className="p-2.5 rounded bg-slate-50 border border-slate-200 text-xs flex items-center justify-between">
                <span>Step 1: Scheme Eligibility Appraisal</span>
                <Badge variant="primary" className="text-[10px]">Active</Badge>
              </StaggerItem>
              <StaggerItem className="p-2.5 rounded bg-slate-50 border border-slate-200 text-xs flex items-center justify-between">
                <span>Step 2: DPR &amp; Project Valuation</span>
        ...
        <Card variant="standard" className="space-y-4">
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs text-slate-500 text-center">
              Move cursor near the button to test restrained 6px attraction.
            </p>
          </CardContent>
        </Card>
            ...
            <CardTilt>
              <div className="p-5 rounded-lg bg-gradient-to-br from-slate-900 to-slate-950 text-white border border-slate-800 shadow-elevated space-y-2">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  Hover and move cursor to observe the gentle 3-degree 3D perspective.
                </p>
              </div>
            </CardTilt>
          </CardContent>
        ...
        <Card variant="standard" className="space-y-4 md:col-span-2 lg:col-span-3">
          <CardHeader>
            <div className="flex items-center justify-between">
            ...
            <CardDescription>
              Gentle scroll interpolation for background visual accents. Automatically disabled on reduced motion.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-28 rounded-lg bg-slate-50 overflow-hidden relative flex items-center justify-center p-4 border border-slate-200">
              <Parallax speed={0.2} offsetDistance={16}>
                <div className="p-3.5 rounded-md bg-white border border-teal-200/80 shadow-subtle flex items-center gap-2.5 text-xs text-teal-800 font-medium">
                  <Compass className="w-4 h-4 text-teal-600" />
                  <span>Scroll Up and Down to Observe Subtle Parallax Float (16px)</span>
                </div>
              </Parallax>
            </div>
          </CardContent>
      ...
      <div className="pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4 text-xs text-slate-500">
        <div className="flex items-center gap-6 flex-wrap">
          <span className="flex items-center gap-1.5">
            ...
            100% Framer Motion &amp; CSS transitions
          </span>
          <span className="flex items-center gap-1.5">
            <CheckCircle2 className="w-4 h-4 text-emerald-600" />
        ...
        <div className="text-slate-400">
          Ready for Phase 7 (Home Page Core Experience)
        </div>
      </div>
    </section>
  );
