    ...
    >
      ...
      <Container width="wide" className="relative z-10 space-y-16 sm:space-y-20">
        ...
        <div className="space-y-4 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-50 border border-purple-200 text-[#581C87] text-xs font-mono tracking-widest uppercase">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="relative rounded-2xl overflow-hidden border border-purple-100 bg-white shadow-[0_24px_60px_-15px_rgba(0,0,0,0.85)] group">
              ...
              <div className="p-5 bg-[#FAF9FE] border-t border-purple-100 space-y-2">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-serif text-base sm:text-lg font-medium text-[#0F0A1A]">
                      {founder.name}
                    </h3>
                    <p className="text-[11px] font-mono text-[#581C87] uppercase tracking-wider">
                      {founder.role} &bull; Agnivridhi India
                    </p>
                  </div>

                  <div className="w-9 h-9 rounded-xl bg-white/[0.04] border border-purple-100 flex items-center justify-center text-[#581C87] shrink-0">
                    <Award className="w-4 h-4" />
                  </div>
                </div>

                <div className="pt-2 border-t border-purple-100 flex items-center justify-between text-[11px] font-mono text-[#64748B]">
                  <span>India Business Awards 2025</span>
                  <span className="text-[#581C87]">New Delhi</span>
                </div>
              </div>
            </div>

            {/* Leadership Verification Pill */}
            <div className="p-4 rounded-xl bg-white/[0.02] border border-purple-100 flex items-center justify-between text-xs font-mono text-[#475569]">
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-[#581C87]" />
                <span>Executive Member</span>
              </div>
              <span className="text-[#0F0A1A]">MSME Growth Council</span>
            </div>
          </div>

          {/* Right Column: In-Depth Institutional Narrative & 3 Principles (7 cols) */}
          <div className="lg:col-span-7 space-y-8 text-left">
            <div className="space-y-4 font-sans text-sm sm:text-base text-[#475569] leading-relaxed">
              <p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="divide-y divide-white/[0.08] border-y border-purple-100">
                <div className="py-4 space-y-1.5">
                  <div className="flex items-center gap-2.5">
                    <span className="font-mono text-xs text-[#581C87]">01</span>
                    <h4 className="font-serif text-lg text-[#0F0A1A] font-normal">
                      Zero Unregulated Intermediation
                    </h4>
                  </div>
                  <p className="font-sans text-xs sm:text-sm text-[#475569] leading-relaxed pl-6">
                ...
                <div className="py-4 space-y-1.5">
                  <div className="flex items-center gap-2.5">
                    <span className="font-mono text-xs text-[#581C87]">02</span>
                    <h4 className="font-serif text-lg text-[#0F0A1A] font-normal">
                ...
                <div className="py-4 space-y-1.5">
                  <div className="flex items-center gap-2.5">
                    <span className="font-mono text-xs text-[#581C87]">03</span>
                    <h4 className="font-serif text-lg text-[#0F0A1A] font-normal">
            ...
            <div className="pt-2 flex items-center gap-4">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#581C87] hover:bg-[#4C1D95] text-white font-sans font-semibold text-xs tracking-wider uppercase transition-all shadow-md group shadow-[0_4px_16px_rgba(88,28,135,0.2)]"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-purple-200 hover:border-purple-300 text-[#0F0A1A] hover:text-[#581C87] hover:bg-purple-50 text-xs font-mono tracking-wider uppercase transition-all shadow-xs"
              >
