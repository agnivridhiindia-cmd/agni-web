      ...
      <Container width="wide" className="relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 sm:space-y-10">
          ...
          <FadeIn direction="up" distance={18} delay={0.08}>
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight text-[#0F0A1A] leading-[1.15]">
              &ldquo;Growth becomes sustainable when ambition is supported by{" "}
              <span className="text-[#581C87] italic font-light">structure</span>.&rdquo;
            </h2>
          </FadeIn>

          {/* Concise Human Paragraph */}
          <FadeIn direction="up" distance={16} delay={0.15}>
            <p className="font-sans text-base sm:text-lg text-[#475569] max-w-2xl mx-auto leading-relaxed font-normal">
          ...
          <FadeIn direction="up" distance={12} delay={0.22}>
            <div className="pt-2 flex items-center justify-center gap-6">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-xs font-mono tracking-wider uppercase text-[#581C87] hover:text-[#7C3AED] transition-colors group"
              >
