            ...
            <div className="pt-2 w-full max-w-sm sm:max-w-md">
              <div className="relative w-full h-60 sm:h-64 rounded-xl overflow-hidden border border-slate-700/80 shadow-lg group">
                ...
                <div className="absolute top-2.5 left-2.5 z-20 pointer-events-none">
                  <span className="px-2.5 py-1 rounded-md bg-slate-900/90 backdrop-blur-md border border-slate-700/90 text-[11px] font-mono text-cyan-300 flex items-center gap-1.5 shadow-sm">
