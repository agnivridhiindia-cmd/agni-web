...
export function ContactInfo() {
 ...
 {/* Office Location */}
 <div className="p-5 rounded-3xl bg-white/85 border border-white/90 flex items-start gap-3.5 shadow-[0_16px_40px_rgba(15,23,42,0.08)]  hover:border-amber-400/60 hover:shadow-[0_24px_50px_rgba(14,165,233,0.18)] transition-all">
 ...
 {hasDirectChannels && (
 <div className="p-5 rounded-3xl bg-white/85 border border-white/90 space-y-3 shadow-[0_16px_40px_rgba(15,23,42,0.08)]">
 ...
 <div className="flex items-start gap-3 p-4 rounded-3xl bg-white/85 border border-white/90 text-xs text-slate-700 font-sans leading-relaxed shadow-[0_16px_40px_rgba(15,23,42,0.08)]">
