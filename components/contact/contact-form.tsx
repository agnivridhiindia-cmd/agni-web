...
export function ContactForm({ initialService = "" }: ContactFormProps) {
  ...
  if (isSubmitted) {
    return (
      <div className="p-8 md:p-10 rounded-3xl bg-white/95 border border-white/90 shadow-[0_20px_50px_rgba(15,23,42,0.1)] backdrop-blur-2xl [transform:translateZ(0)] text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
  ...
  return (
    <div className="relative rounded-3xl bg-white/90 border border-white/95 shadow-[0_20px_50px_rgba(15,23,42,0.1)] backdrop-blur-2xl [transform:translateZ(0)] overflow-hidden">
