...
export function MapLocation() {
  ...
  return (
    <Card variant="standard" className="p-6 rounded-2xl border-slate-200/90 bg-white space-y-4 shadow-xs">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-serif font-semibold text-slate-900 text-lg">
              {city}, {state}
            </p>
          </div>
        </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold text-teal-800 bg-teal-50 hover:bg-teal-100 border border-teal-200/80 transition-colors shrink-0"
        >
