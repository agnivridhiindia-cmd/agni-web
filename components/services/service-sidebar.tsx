    ...
    >
      ...
      <div className="sticky top-28 space-y-6">
        ...
        <div className="rounded-2xl bg-[#111313] border border-[#232727] shadow-2xl overflow-hidden">
          {/* Header Bar */}
          <div className="p-6 bg-[#080909] text-[#F3EFE7] border-b border-[#232727] space-y-2 relative overflow-hidden">
            <div
              className="absolute top-0 right-0 w-32 h-32 bg-[#C79A4A]/10 rounded-full blur-2xl pointer-events-none"
              aria-hidden="true"
            />

            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-white/5 border border-[#232727] flex items-center justify-center text-[#C79A4A]">
              ...
              <div className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#C79A4A]/15 border border-[#C79A4A]/30 text-[#DFC286] text-[10px] font-mono font-bold">
                <span className="w-1.5 h-1.5 rounded-full bg-[#C79A4A] animate-pulse" />
                <span>Active Mandate</span>
              </div>
            </div>

            <h3 className="font-serif text-lg font-bold text-[#F3EFE7] tracking-tight leading-snug pt-1">
              {service.name}
            </h3>
          </div>
          ...
          <div className="p-6 divide-y divide-[#232727] space-y-3.5 text-xs font-sans">
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="space-y-0.5">
                <span className="text-[11px] font-mono font-semibold uppercase tracking-wider text-[#8E8B82] block">
                  Max Limit / Scale
                </span>
                <span className="text-[#D1CBC1]">Statutory Scheme Cap</span>
              </div>
              <div className="font-mono text-base font-bold text-[#F3EFE7] tabular-nums text-right">
                {maxLimit}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-3.5">
              <div className="space-y-0.5">
                ...
                <span className="text-[#D1CBC1]">Third-Party Guarantee</span>
              </div>
              <div className="font-mono text-sm font-bold text-[#DFC286] bg-[#C79A4A]/10 px-2.5 py-1 rounded-md border border-[#C79A4A]/30 text-right">
                {collateral}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-3.5">
              <div className="space-y-0.5">
                ...
                <span className="text-[#D1CBC1]">DPR to Sanction SLA</span>
              </div>
              <div className="font-mono text-sm font-bold text-[#F3EFE7] text-right flex items-center gap-1">
          ...
          <div className="p-6 pt-2 bg-[#181A1A]/70 border-t border-[#232727] space-y-2.5">
            {/* Quick Button 1: Download DPR Checklist */}
            <button
              type="button"
              onClick={handleDownloadDprChecklist}
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#141616] hover:bg-[#1C1F1F] text-[#F3EFE7] font-sans text-xs font-semibold tracking-wide border border-[#232727] hover:border-[#C79A4A]/40 shadow-2xs transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C79A4A]"
            >
              <FileDown className="w-4 h-4 text-[#C79A4A] shrink-0" />
            ...
            <Link
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#C79A4A] hover:bg-[#DFC286] text-[#080909] font-sans text-xs font-bold tracking-wide transition-all shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C79A4A]"
            >
          ...
          <div className="px-6 py-4 bg-[#141616] border-t border-[#232727] space-y-2 text-[11px] text-[#D1CBC1] font-sans">
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-3.5 h-3.5 text-[#C79A4A] shrink-0" />
              <span>Direct review by accredited banking underwriters</span>
            </div>
            <div className="flex items-center gap-2">
              <Lock className="w-3.5 h-3.5 text-[#C79A4A] shrink-0" />
        ...
        <div className="p-5 rounded-2xl border border-[#232727] bg-[#111313] text-xs space-y-2.5 shadow-xs">
          <span className="font-mono text-[11px] font-bold text-[#8E8B82] uppercase tracking-wider block">
            Dedicated Practice Desk
          </span>
          <p className="text-[#D1CBC1] leading-relaxed font-sans">
            Delivered under Agnivridhi&apos;s <strong>{categoryLabel}</strong> practice desk.
          </p>
          <Link
            href={`/services#${service.category}`}
            className="inline-flex items-center gap-1 font-semibold text-[#C79A4A] hover:text-[#DFC286] transition-colors pt-1"
          >
