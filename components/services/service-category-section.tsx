...
export function ServiceCategorySection({
 ...
 <div className="mt-4 pl-4 border-l-4 border-amber-500 py-3 text-xs sm:text-sm font-sans italic bg-white/80 text-slate-800 rounded-r-2xl pr-4 border-y border-r border-[#A6CCEA]/80 shadow-2xs max-w-3xl font-medium">
 &ldquo;{pov}&rdquo;
 </div>
 </div>
 </div>
