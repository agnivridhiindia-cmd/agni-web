...
export function ServiceOverview({ service }: ServiceOverviewProps) {
 ...
 <div
 key={idx}
 className="p-5 rounded-2xl border border-slate-700/60 bg-gradient-to-b from-[#131D38]/90 via-[#0E162B]/95 to-[#0A1020]/95 shadow-[0_16px_40px_rgba(0,0,0,0.4)]  flex items-start gap-3.5 hover:border-amber-500/40 transition-all"
 >
 ...
 <div className="p-6 sm:p-7 rounded-2xl bg-gradient-to-b from-[#131D38]/90 via-[#0E162B]/95 to-[#0A1020]/95 border border-slate-700/60 space-y-4 shadow-[0_16px_40px_rgba(0,0,0,0.4)]">
