...
export function ServiceFaq({ faqs, serviceName }: ServiceFaqProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-700/60 bg-gradient-to-b from-[#131D38]/90 via-[#0E162B]/95 to-[#0A1020]/95 p-6 sm:p-7 shadow-[0_16px_40px_rgba(0,0,0,0.4)] backdrop-blur-xl">
