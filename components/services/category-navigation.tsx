...
export function CategoryNavigation({
 ...
 className="sticky top-[68px] sm:top-[76px] z-30 bg-white/80  border-b border-[#A6CCEA] shadow-[0_4px_20px_rgba(15,23,42,0.06)] transition-colors py-3"
 >
 <Container width="wide">
 <div className="flex items-center justify-between gap-4">
 {/* Linear-Style Segmented Dock with Frosted Glassmorphic Styling */}
 <div className="grid w-full grid-cols-2 items-center gap-1.5 rounded-2xl bg-white/90 p-1.5  border border-[#A6CCEA] shadow-[0_4px_16px_rgba(15,23,42,0.08)] [transform:translateZ(0)] lg:inline-flex lg:w-auto lg:gap-0">
