...
export function ServiceBreadcrumb({ service }: ServiceBreadcrumbProps) {
  ...
  return (
    <nav
      ...
      className="border-b border-[#232727] bg-[#080909] pt-28 sm:pt-32 pb-4 text-xs text-[#8E8B82] font-sans"
    >
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <ol className="flex items-center flex-wrap gap-2">
            <li>
              <Link
                href="/"
                className="hover:text-[#C79A4A] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-teal-600 rounded px-1 -mx-1"
              >
                Home
              </Link>
            </li>
            <li aria-hidden="true">
              <ChevronRight className="w-3.5 h-3.5 text-[#8E8B82] shrink-0" />
            </li>
            <li>
              <Link
                href="/services"
            ...
            <li
              aria-current="page"
              className="font-medium text-[#F3EFE7] truncate max-w-[200px] sm:max-w-md"
            >
              {service.name}
            </li>
          </ol>
