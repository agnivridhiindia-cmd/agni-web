  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute -top-20 right-[-5%] h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle,rgba(6,182,212,0.18)_0%,rgba(14,116,144,0.08)_45%,transparent_70%)] blur-2xl" />
        <div className="absolute top-[38%] left-[-12%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle,rgba(245,158,11,0.15)_0%,rgba(217,119,6,0.06)_45%,transparent_72%)] blur-2xl" />
      </div>

      <Container width="wide" className="relative z-10">
        <div className="max-w-3xl space-y-6">
          <FadeIn direction="up" distance={14} delay={0.05}>
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-amber-950/90 backdrop-blur-md border border-amber-500/40 text-xs font-mono tracking-widest text-amber-300 shadow-xs">
          ...
          <FadeIn direction="up" distance={16} delay={0.2}>
            <div className="pt-2 flex flex-wrap items-center gap-3 text-xs font-sans">
              <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-gradient-to-b from-[#131D38]/90 via-[#0E162B]/95 to-[#0A1020]/95 border border-slate-700/60 text-slate-300 shadow-xs text-xs font-mono backdrop-blur-md">
