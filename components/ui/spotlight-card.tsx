...
export const SpotlightCard = React.forwardRef<HTMLDivElement, SpotlightCardProps>(
 ...
 <div
 className={cn(
 "relative h-full w-full rounded-[calc(1.5rem-1px)] bg-slate-950/85  text-slate-100 p-6 sm:p-7 flex flex-col justify-between overflow-hidden transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]",
 innerClassName
 )}
 >
