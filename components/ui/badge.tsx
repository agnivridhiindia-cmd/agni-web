...
export const badgeVariants = cva(
 ...
 glass:
 "bg-white/[0.05]  text-[#F3EFE7] border border-white/[0.1] shadow-xs hover:bg-white/[0.08] transition-colors",
 "glass-teal":
 "bg-[#C79A4A]/15  text-[#DFC286] border border-[#C79A4A]/30 shadow-xs",
 "glass-accent":
 "bg-[#C79A4A]/20  text-[#DFC286] border border-[#C79A4A]/40 shadow-xs",
 },
 },
 defaultVariants: {
 variant: "default",
