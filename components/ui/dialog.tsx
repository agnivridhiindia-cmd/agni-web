...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 text-[#64748B] opacity-70 transition-all hover:opacity-100 hover:text-[#0F0A1A] hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-[#581C87]">
        <X className="h-4 w-4" />
