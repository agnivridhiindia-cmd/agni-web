...
export function LegalNav({ currentPage }: LegalNavProps) {
  return (
    <div className="border-b border-purple-100 bg-white/95 backdrop-blur-md sticky top-16 sm:top-20 z-20 shadow-2xs">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-purple-50 text-[#0F0A1A] border border-[#581C87]/60 shadow-2xs font-semibold"
