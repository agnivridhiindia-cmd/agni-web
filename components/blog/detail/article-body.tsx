...
export function ArticleBody({ content }: ArticleBodyProps) {
 ...
 <blockquote
 key={idx}
 className="my-6 pl-5 border-l-4 border-amber-500 bg-white/80 py-4 pr-4 rounded-r-2xl border-y border-r border-white/90 italic text-slate-900 font-serif text-lg leading-relaxed shadow-sm"
 >
