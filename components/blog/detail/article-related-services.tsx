        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
          {services.map((service) => (
            <Link
              ...
              className="group p-5 rounded-2xl border border-white/90 bg-white/85 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl hover:border-amber-400/60 hover:shadow-[0_16px_40px_rgba(14,165,233,0.15)] transition-all flex flex-col justify-between space-y-3"
            >
