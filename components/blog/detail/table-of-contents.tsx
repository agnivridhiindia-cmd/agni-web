...
export function TableOfContents({ items, variant = "all", className }: TableOfContentsProps) {
 ...
 {showMobile && (
 <div className={cn("rounded-2xl border border-white/90 bg-white/85 overflow-hidden shadow-md", variant === "all" ? "lg:hidden my-8" : "")}>
 <button
 type="button"
 ...
 {showDesktop && (
 <div className={cn("sticky top-28 space-y-3.5 p-5 rounded-3xl border border-white/90 bg-white/85  shadow-[0_16px_40px_rgba(15,23,42,0.08)]", variant === "all" ? "hidden lg:block w-72 shrink-0" : "")}>
