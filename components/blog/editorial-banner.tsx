  ...
  if (isCgtmse) {
    return (
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full bg-amber-500/10 blur-3xl pointer-events-none"
        />
  ...
  if (isIso) {
    return (
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute -top-20 -left-20 w-72 h-72 rounded-full bg-amber-500/15 blur-3xl pointer-events-none"
        />
        <div
          aria-hidden="true"
