      ...
      <Container width="wide">
        <div className="max-w-3xl space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
            ...
            {totalArticles > 0 && (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded text-xs font-mono text-[#7C3AED] bg-purple-50/60 border border-purple-100 shadow-xs">
                <BookOpen className="w-3.5 h-3.5 text-[#581C87] shrink-0" aria-hidden="true" />
