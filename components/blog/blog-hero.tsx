      ...
      <Container width="wide">
        <div className="max-w-3xl space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
            ...
            {totalArticles > 0 && (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded text-xs font-mono text-[#DFC286] bg-[#141616] border border-[#232727] shadow-xs">
                <BookOpen className="w-3.5 h-3.5 text-[#C79A4A] shrink-0" aria-hidden="true" />
