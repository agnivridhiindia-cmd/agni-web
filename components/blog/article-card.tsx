...
export function ArticleCard({ post, featured = false, className }: ArticleCardProps) {
 ...
 <article
 className={cn(
 "group relative rounded-3xl border border-white/90 bg-white/85 shadow-[0_16px_40px_rgba(15,23,42,0.08)]  hover:border-amber-400/60 hover:shadow-[0_24px_50px_rgba(14,165,233,0.18)] transition-all duration-300 ease-out hover:-translate-y-1.5 overflow-hidden [transform:translateZ(0)]",
 className
 )}
 >
 ...
 <article
 className={cn(
 "group relative flex flex-col justify-between rounded-3xl border border-white/90 bg-white/85 shadow-[0_16px_40px_rgba(15,23,42,0.08)]  hover:border-amber-400/60 hover:shadow-[0_24px_50px_rgba(14,165,233,0.18)] hover:-translate-y-1.5 transition-all duration-300 ease-out overflow-hidden [transform:translateZ(0)]",
 className
 )}
 >
