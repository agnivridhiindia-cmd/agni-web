...
export function CoreValues() {
 ...
 <div className="absolute top-1/4 -right-32 h-96 w-96 rounded-full bg-[radial-gradient(circle,rgba(245,158,11,0.12)_0%,transparent_70%)]" />
 <div className="absolute bottom-10 -left-32 h-96 w-96 rounded-full bg-[radial-gradient(circle,rgba(6,182,212,0.10)_0%,transparent_70%)]" />
 ...
 delay={0.1 + idx * 0.06}
 >
 <div className="h-full p-7 sm:p-8 rounded-2xl bg-gradient-to-b from-[#131D38]/90 via-[#0E162B]/95 to-[#0A1020]/95 border border-slate-700/60  shadow-[0_16px_40px_rgba(0,0,0,0.4)] hover:border-amber-500/50 hover:shadow-[0_20px_50px_rgba(0,0,0,0.6)] transition-all duration-300 flex flex-col justify-between space-y-6 group">
