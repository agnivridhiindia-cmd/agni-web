...
export function MissionSection() {
 ...
 <div className="absolute top-0 right-1/4 w-96 h-96 bg-amber-500/12 rounded-full" />
 <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-cyan-500/10 rounded-full" />
 ...
 <div
 key={pillar.step}
 className="space-y-3 p-6 rounded-2xl bg-gradient-to-b from-[#131D38]/90 via-[#0E162B]/95 to-[#0A1020]/95 border border-slate-700/60 shadow-[0_16px_40px_rgba(0,0,0,0.4)]  hover:border-amber-500/50 transition-all group"
 >
