...
export function FounderTransition() {
  return (
    <section
      ...
      className="py-16 sm:py-20 lg:py-24 bg-slate-50/60 border-t border-slate-200/80"
    >
      <Container width="wide">
        <FadeIn direction="up" distance={16} delay={0.05}>
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 border border-teal-200/80 text-teal-700 text-xs font-mono tracking-wider uppercase mx-auto">
            ...
            <h2
              ...
              className="font-serif text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 tracking-tight leading-snug"
            >
              Direct Advisory Accountability at Every Stage of Scale.
            </h2>

            <p className="type-body text-slate-600 font-sans leading-relaxed">
