...
export function CompanyStory() {
 ...
 <div className="p-6 sm:p-7 rounded-3xl bg-white/75 border border-white/90  shadow-[inset_0_1px_2px_rgba(255,255,255,0.95),0_20px_45px_-12px_rgba(14,165,233,0.12)] ring-1 ring-slate-900/5 space-y-3 mt-6">
