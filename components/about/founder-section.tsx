          ...
          <div className="lg:col-span-7 space-y-8 font-sans text-slate-800">
            ...
            {founder.quote && (
              <FadeIn direction="up" distance={16} delay={0.15}>
                <div className="p-7 sm:p-9 rounded-2xl bg-white/85 border border-white/95 shadow-[inset_0_1px_2px_rgba(255,255,255,0.95),0_20px_45px_-12px_rgba(14,165,233,0.12)] ring-1 ring-slate-900/5 backdrop-blur-md space-y-5 relative overflow-hidden">
                  <div
